...
export type StateMachineViewerProps={nodes:StateNode[];edges:StateEdge[];active:string;onSelect?:(id:string)=>void};

export function StateMachineViewer(props:StateMachineViewerProps){
 const {nodes,edges,active,onSelect}=props;
