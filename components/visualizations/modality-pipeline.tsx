...
export type ModalityPipelineProps={active?:Modality;seen?:Modality[];onSelect?:(m:Modality)=>void};
...
export const ModalityPipeline:FC<ModalityPipelineProps>=({active="text",seen=[],onSelect})=>{
