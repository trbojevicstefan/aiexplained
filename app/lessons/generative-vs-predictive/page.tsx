...
export default function GenerativeVsPredictivePage() {
  return (
    <LessonShell lessonId="generative-vs-predictive" lessonTitle="Generative vs predictive" sections={generativePredictiveSections}>
      {(progress) => <GenerativeVsPredictiveLesson progress={progress} />}
    </LessonShell>
  );
}
