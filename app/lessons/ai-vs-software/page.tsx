...
export default function AiVsSoftwarePage() {
  return <LessonShell lessonId="ai-vs-software" lessonTitle="AI vs software" sections={aiVsSoftwareSections}>{(progress) => <AiVsSoftwareLesson progress={progress} />}</LessonShell>;
}
