...
export default function TrainingVsInferencePage() {
  return (
    <LessonShell lessonId="training-vs-inference" lessonTitle="Training vs inference" sections={trainingInferenceSections}>
      {(progress) => <TrainingVsInferenceLesson progress={progress} />}
    </LessonShell>
  );
}
