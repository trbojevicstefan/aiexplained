...
export default function SymbolicVsNeuralPage() {
  return <LessonShell lessonId="symbolic-vs-neural" lessonTitle="Symbolic vs neural" sections={symbolicNeuralSections}>{(progress) => <SymbolicVsNeuralLesson progress={progress} />}</LessonShell>;
}
